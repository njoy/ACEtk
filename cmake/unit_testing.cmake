...
add_subdirectory( src/ACEtk/ElectronTable/test )
...
add_subdirectory( src/ACEtk/continuous/InterpolationData/test )
...
add_subdirectory( src/ACEtk/electroatomic/ElectronShellBlock/test )
add_subdirectory( src/ACEtk/electroatomic/ElectronSubshellBlock/test )
add_subdirectory( src/ACEtk/electroatomic/PrincipalCrossSectionBlock/test )
add_subdirectory( src/ACEtk/electroatomic/ElasticCrossSectionBlock/test )
add_subdirectory( src/ACEtk/electroatomic/ExcitationBlock/test )
add_subdirectory( src/ACEtk/electroatomic/BremsstrahlungBlock/test )
add_subdirectory( src/ACEtk/electroatomic/SubshellTransitionData/test )
add_subdirectory( src/ACEtk/electroatomic/SubshellTransitionDataBlock/test )
add_subdirectory( src/ACEtk/electroatomic/TabulatedAngularDistribution/test )
add_subdirectory( src/ACEtk/electroatomic/ElasticAngularDistributionBlock/test )
add_subdirectory( src/ACEtk/electroatomic/TabulatedEnergyDistribution/test )
add_subdirectory( src/ACEtk/electroatomic/EnergyDistributionBlock/test )

add_subdirectory( src/ACEtk/electron/BremsstrahlungAngularSpectrumBlock/test )
add_subdirectory( src/ACEtk/electron/BremsstrahlungCorrectionFactorBlock/test )
add_subdirectory( src/ACEtk/electron/BremsstrahlungEnergySpectrumBlock/test )
add_subdirectory( src/ACEtk/electron/BremsstrahlungHighFrequencyBlock/test )
add_subdirectory( src/ACEtk/electron/BremsstrahlungProductionBlock/test )
add_subdirectory( src/ACEtk/electron/MottScatteringCorrectionBlock/test )
add_subdirectory( src/ACEtk/electron/OscillatorBlock/test )
add_subdirectory( src/ACEtk/electron/RadiationStoppingPowerBlock/test )
add_subdirectory( src/ACEtk/electron/RileyCrossSectionBlock/test )
add_subdirectory( src/ACEtk/electron/TransitionEnergyBlock/test )
