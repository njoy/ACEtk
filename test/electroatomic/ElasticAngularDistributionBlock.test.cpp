...
using ElasticAngularDistributionBlock = electroatomic::ElasticAngularDistributionBlock;
using TabulatedAngularDistribution = electroatomic::TabulatedAngularDistribution;
