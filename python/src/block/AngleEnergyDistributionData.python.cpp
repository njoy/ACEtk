...
void wrapAngleEnergyDistributionData( python::module& module,
                                         python::module& ) {

  // type aliases
  using Block = njoy::ACEtk::block::AngleEnergyDistributionData;
  using Distribution = njoy::ACEtk::block::TabulatedAngleEnergyDistribution;
