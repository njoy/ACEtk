...
void wrapOutgoingEnergyDistributionData( python::module& module,
  ...
  .def(
    ...
    &Block::LOCC,
    python::arg( "index" ),
    "Return the the outgoing energy distribution locator for an incident energy index\n\n"
  ...
  .def(
    ...
    python::arg( "index" ),
    "Return the relative outgoing energy distribution locator for an incident energy index\n\n"
  ...
  .def(
    ...
    &Block::distribution,
    python::arg( "index" ),
    "Return the outgoing energy distribution data for an incident energy index\n\n"
    "When the index is out of range an out of range exception is thrown\n"
    "(debug mode only).\n\n"
    "    self     the block\n"
    "    index    the index (one-based)"
