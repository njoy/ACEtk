...
void wrapElasticAngularDistributionBlock( python::module& module, python::module& ) {
  ...
  // type aliases
  using Block = njoy::ACEtk::electroatomic::ElasticAngularDistributionBlock;
  using TabulatedAngularDistribution = njoy::ACEtk::electroatomic::TabulatedAngularDistribution;
