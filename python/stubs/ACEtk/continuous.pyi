...
class SecondaryParticleLocatorBlock:
    ...
    def YP(self, index: int) -> int:
        ...
        Arguments:
            ...
            index    the secondary particle index (one-based)
        """
    def __init__(self, locators: list[typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(10)]]) -> None:
        """
        Initialise the block
