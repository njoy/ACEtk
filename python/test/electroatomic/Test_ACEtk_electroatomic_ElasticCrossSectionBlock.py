...
# local imports
from ACEtk.electroatomic import ElasticCrossSectionBlock

class Test_ACEtk_electroatomic_ElasticCrossSectionBlock( unittest.TestCase ) :
    """Unit test for the ElasticCrossSectionBlock class."""
    ...
    def test_component( self ) :
        ...
        chunk = ElasticCrossSectionBlock(
                  transport = [ 1., 2., 3. ],
                  total = [ 4., 5., 6. ] )
