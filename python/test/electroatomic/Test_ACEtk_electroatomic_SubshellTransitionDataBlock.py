...
# local imports
from ACEtk.electroatomic import SubshellTransitionDataBlock
from ACEtk.electroatomic import SubshellTransitionData

class Test_ACEtk_electroatomic_SubshellTransitionDataBlock( unittest.TestCase ) :
