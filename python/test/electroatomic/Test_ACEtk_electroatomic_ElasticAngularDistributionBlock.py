...
# local imports
from ACEtk.electroatomic import ElasticAngularDistributionBlock
from ACEtk.electroatomic import TabulatedAngularDistribution

class Test_ACEtk_electroatomic_ElasticAngularDistributionBlock( unittest.TestCase ) :
