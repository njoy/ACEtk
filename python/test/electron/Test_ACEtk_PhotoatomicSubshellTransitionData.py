...
class Test_ACEtk_PhotoatomicSubshellTransitionData( unittest.TestCase ) :
    """Unit test for the PhotoatomicSubshellTransitionData class."""
    ...
    def test_component( self ) :
        ...
        chunk = PhotoatomicSubshellTransitionData(
                  primary = [ 1, 2, 3 ],
                  secondary = [ 0, 3, 1 ],
