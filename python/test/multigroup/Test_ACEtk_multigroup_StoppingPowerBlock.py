...
# local imports
from ACEtk.multigroup import StoppingPowerBlock

class Test_ACEtk_multigroup_StoppingPowerBlock( unittest.TestCase ) :
    """Unit test for the StoppingPowerBlock class."""
  ...
  8.187100000000E-11,  2.337520000000E-11]
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( "STOP", chunk.name )

            self.assertEqual( 30, len( chunk.xss_array ) )

            self.assertEqual( 30, len( chunk.stopping_power ) )

            self.assertAlmostEqual( 3.227570000000E-05, chunk.stopping_power[0] )
            self.assertAlmostEqual( 2.337520000000E-11, chunk.stopping_power[-1] )
            self.assertAlmostEqual( 3.227570000000E-05, chunk.SPOW[0] )
            self.assertAlmostEqual( 2.337520000000E-11, chunk.SPOW[-1] )
        ...
        chunk = StoppingPowerBlock(
          stopping_power =  [   3.227570000000E-05,  7.312440000000E-05,  2.343740000000E-04,  1.240120000000E-03,
              6.713940000000E-03,  2.068860000000E-02,  1.217780000000E-01,  1.038050000000E-01,
  1.194360000000E-01,  1.214190000000E-01,  1.115690000000E-01,  1.706130000000E-01,
  1.047060000000E-01,  5.813530000000E-02,  3.017230000000E-02,  2.257480000000E-02,
  5.273470000000E-03,  1.190540000000E-03,  2.672500000000E-04,  5.953610000000E-05,
