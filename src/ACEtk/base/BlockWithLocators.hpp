#ifndef NJOY_ACETK_BASE_BLOCKWITHLOCATORS
#define NJOY_ACETK_BASE_BLOCKWITHLOCATORS
...
class BlockWithLocators : protected Base {
  ...
  /* auxiliary functions */
  #include "ACEtk/base/BlockWithLocators/src/generateXSS.hpp"
  #include "ACEtk/base/BlockWithLocators/src/generateData.hpp"
  #include "ACEtk/base/BlockWithLocators/src/generateBlocks.hpp"
  #include "ACEtk/base/BlockWithLocators/src/verifySize.hpp"

protected:

  /* auxiliary functions */
  #include "ACEtk/base/BlockWithLocators/src/verifyDataIndex.hpp"

  /* constructor */
  #include "ACEtk/base/BlockWithLocators/src/ctor.hpp"
