...
class ElectronBlockWithLocators : protected Base {
  ...
  /* auxiliary functions */
  #include "ACEtk/base/ElectronBlockWithLocators/src/generateXSS.hpp"
  #include "ACEtk/base/ElectronBlockWithLocators/src/generateBlocks.hpp"

protected:

  /* auxiliary functions */
  #include "ACEtk/base/ElectronBlockWithLocators/src/verifyDataIndex.hpp"
