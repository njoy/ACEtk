#ifndef NJOY_ACETK_ELECTROATOMIC_TABULATEDENERGYDISTRIBUTION
#define NJOY_ACETK_ELECTROATOMIC_TABULATEDENERGYDISTRIBUTION
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/TabulatedEnergyDistribution/src/ctor.hpp"
