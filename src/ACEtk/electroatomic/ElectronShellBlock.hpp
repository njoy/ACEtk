#ifndef NJOY_ACETK_ELECTROATOMIC_ELECTRONSHELLBLOCK
#define NJOY_ACETK_ELECTROATOMIC_ELECTRONSHELLBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/ElectronShellBlock/src/ctor.hpp"
