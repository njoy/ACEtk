#ifndef NJOY_ACETK_ELECTROATOMIC_TABULATEDANGULARDISTRIBUTION
#define NJOY_ACETK_ELECTROATOMIC_TABULATEDANGULARDISTRIBUTION
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/TabulatedAngularDistribution/src/ctor.hpp"
