#ifndef NJOY_ACETK_ELECTROATOMIC_ELASTICANGULARDISTRIBUTIONBLOCK
#define NJOY_ACETK_ELECTROATOMIC_ELASTICANGULARDISTRIBUTIONBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/ElasticAngularDistributionBlock/src/ctor.hpp"
