#ifndef NJOY_ACETK_ELECTROATOMIC_ENERGYDISTRIBUTIONBLOCK
#define NJOY_ACETK_ELECTROATOMIC_ENERGYDISTRIBUTIONBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/EnergyDistributionBlock/src/ctor.hpp"
