#ifndef NJOY_ACETK_ELECTROATOMIC_ELECTRONSUBSHELLBLOCK
#define NJOY_ACETK_ELECTROATOMIC_ELECTRONSUBSHELLBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/ElectronSubshellBlock/src/ctor.hpp"
