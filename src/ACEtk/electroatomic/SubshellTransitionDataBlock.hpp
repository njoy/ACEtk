#ifndef NJOY_ACETK_ELECTROATOMIC_SUBSHELLTRANSITIONDATABLOCK
#define NJOY_ACETK_ELECTROATOMIC_SUBSHELLTRANSITIONDATABLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/SubshellTransitionDataBlock/src/ctor.hpp"
