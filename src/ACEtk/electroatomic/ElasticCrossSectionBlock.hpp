#ifndef NJOY_ACETK_ELECTROATOMIC_ELASTICCROSSSECTIONBLOCK
#define NJOY_ACETK_ELECTROATOMIC_ELASTICCROSSSECTIONBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/electroatomic/ElasticCrossSectionBlock/src/ctor.hpp"
