#ifndef NJOY_ACETK_CONTINUOUS_KALBACHMANNDISTRIBUTIONDATA
#define NJOY_ACETK_CONTINUOUS_KALBACHMANNDISTRIBUTIONDATA
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/KalbachMannDistributionData/src/ctor.hpp"
