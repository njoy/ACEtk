#ifndef NJOY_ACETK_CONTINUOUS_SECONDARYPARTICLETYPEBLOCK
#define NJOY_ACETK_CONTINUOUS_SECONDARYPARTICLETYPEBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/SecondaryParticleTypeBlock/src/ctor.hpp"
