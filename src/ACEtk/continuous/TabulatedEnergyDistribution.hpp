#ifndef NJOY_ACETK_CONTINUOUS_TABULATEDOUTGOINGENERGYDISTRIBUTION
#define NJOY_ACETK_CONTINUOUS_TABULATEDOUTGOINGENERGYDISTRIBUTION
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/TabulatedEnergyDistribution/src/ctor.hpp"
