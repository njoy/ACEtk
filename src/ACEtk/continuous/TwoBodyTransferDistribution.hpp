#ifndef NJOY_ACETK_CONTINUOUS_TWOBODYTRANSFERDISTRIBUTION
#define NJOY_ACETK_CONTINUOUS_TWOBODYTRANSFERDISTRIBUTION
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/TwoBodyTransferDistribution/src/ctor.hpp"
