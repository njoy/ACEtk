#ifndef NJOY_ACETK_CONTINUOUS_ENERGYANGLEDISTRIBUTIONDATA
#define NJOY_ACETK_CONTINUOUS_ENERGYANGLEDISTRIBUTIONDATA
...
class EnergyAngleDistributionData :
  protected base::DistributionData< EnergyAngleDistributionData,
                                    TabulatedEnergyAngleDistribution > {

  friend class base::DistributionData< EnergyAngleDistributionData,
                                       TabulatedEnergyAngleDistribution >;
...
protected:
  ...
  /* auxiliary functions */
  #include "ACEtk/continuous/EnergyAngleDistributionData/src/generateXSS.hpp"

public:

  /* constructor */
  #include "ACEtk/continuous/EnergyAngleDistributionData/src/ctor.hpp"
