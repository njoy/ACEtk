#ifndef NJOY_ACETK_CONTINUOUS_FRAMEANDMULTIPLICITYBLOCK
#define NJOY_ACETK_CONTINUOUS_FRAMEANDMULTIPLICITYBLOCK
...
class FrameAndMultiplicityBlock : protected base::Base {
  ...
  /* auxiliary functions */
  #include "ACEtk/continuous/FrameAndMultiplicityBlock/src/generateXSS.hpp"
  #include "ACEtk/continuous/FrameAndMultiplicityBlock/src/generateBlocks.hpp"
  #include "ACEtk/continuous/FrameAndMultiplicityBlock/src/verifySize.hpp"

public:

  /* constructor */
  #include "ACEtk/continuous/FrameAndMultiplicityBlock/src/ctor.hpp"
