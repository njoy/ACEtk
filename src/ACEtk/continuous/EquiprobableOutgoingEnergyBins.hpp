#ifndef NJOY_ACETK_CONTINUOUS_EQUIPROBABLEOUTGOINGENERGYBINS
#define NJOY_ACETK_CONTINUOUS_EQUIPROBABLEOUTGOINGENERGYBINS
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/EquiprobableOutgoingEnergyBins/src/ctor.hpp"
