#ifndef NJOY_ACETK_CONTINUOUS_TABULATEDMULTIPLICITY
#define NJOY_ACETK_CONTINUOUS_TABULATEDMULTIPLICITY
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/TabulatedMultiplicity/src/ctor.hpp"
