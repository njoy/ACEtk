#ifndef NJOY_ACETK_CONTINUOUS_ANGULARDISTRIBUTIONBLOCK
#define NJOY_ACETK_CONTINUOUS_ANGULARDISTRIBUTIONBLOCK
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/AngularDistributionBlock/src/ctor.hpp"
