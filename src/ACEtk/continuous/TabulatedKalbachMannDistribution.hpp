#ifndef NJOY_ACETK_CONTINUOUS_TABULATEDKALBACHMANNDISTRIBUTION
#define NJOY_ACETK_CONTINUOUS_TABULATEDKALBACHMANNDISTRIBUTION
...
public:
  ...
  /* constructor */
  #include "ACEtk/continuous/TabulatedKalbachMannDistribution/src/ctor.hpp"
