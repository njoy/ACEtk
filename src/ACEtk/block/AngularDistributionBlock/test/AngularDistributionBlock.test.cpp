...
void verifyChunk( const AngularDistributionBlock& chunk ) {
  ...
  CHECK( -6 == data1.angularDistributionLocator(1) );
  CHECK( -14 == data1.angularDistributionLocator(2) );
  CHECK( AngularDistributionType::Tabulated == data1.angularDistributionType(1) );
  CHECK( AngularDistributionType::Tabulated == data1.angularDistributionType(2) );
  CHECK( 6 == data1.relativeAngularDistributionLocator(1) );
  CHECK( 14 == data1.relativeAngularDistributionLocator(2) );
  ...
  CHECK( -32 == data4.angularDistributionLocator(1) );
  CHECK( 0 == data4.angularDistributionLocator(2) );
  CHECK( -43 == data4.angularDistributionLocator(3) );
  CHECK( AngularDistributionType::Tabulated == data4.angularDistributionType(1) );
  CHECK( AngularDistributionType::Isotropic == data4.angularDistributionType(2) );
  CHECK( AngularDistributionType::Tabulated == data4.angularDistributionType(3) );
  CHECK( 8 == data4.relativeAngularDistributionLocator(1) );
  CHECK( 0 == data4.relativeAngularDistributionLocator(2) );
  CHECK( 19 == data4.relativeAngularDistributionLocator(3) );
  CHECK( true == std::holds_alternative< TabulatedAngularDistribution >( data4.angularDistributionData(1) ) );
  CHECK( true == std::holds_alternative< IsotropicAngularDistribution >( data4.angularDistributionData(2) ) );
  CHECK( true == std::holds_alternative< TabulatedAngularDistribution >( data4.angularDistributionData(3) ) );
}
